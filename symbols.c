...
static match all_keywords[] = {
	 ...
	 *	Opcodes.
	 */
	{ op_aaa,	"aaa"	}, { op_aad,	"aad"	}, { op_aam,	"aam"	},
	{ op_aas,	"aas"	}, { op_adc,	"adc"	}, { op_add,	"add"	},
	{ op_and,	"and"	}, { op_arpl,	"arpl"	}, { op_bound,	"bound"	},
	{ op_break,	"break"	}, { op_call,	"call"	}, { op_cbw,	"cbw"	},
	{ op_clc,	"clc"	}, { op_cld,	"cld"	}, { op_cli,	"cli"	},
	{ op_clts,	"clts"	}, { op_cmc,	"cmc"	}, { op_cmp,	"cmp"	},
	{ op_cmps,	"cmps"	}, { op_cwd,	"cwd"	}, { op_daa,	"daa"	},
	{ op_das,	"das"	}, { op_dec,	"dec"	}, { op_div,	"div"	},
	{ op_enter,	"enter"	}, { op_esc,	"esc"	}, { op_hlt,	"hlt"	},
	{ op_idiv,	"idiv"	}, { op_imul,	"imul"	}, { op_inc,	"inc"	},
	{ op_in,	"in"	}, { op_ins,	"ins"	}, { op_int,	"int"	},
	{ op_into,	"into"	}, { op_intr,	"intr"	}, { op_iret,	"iret"	},
	{ op_jae,	"jae"	}, { op_ja,	"ja"	}, { op_jbe,	"jbe"	},
	{ op_jb,	"jb"	}, { op_jc,	"jc"	}, { op_jcxz,	"jcxz"	},
	{ op_je,	"je"	}, { op_jge,	"jge"	}, { op_jg,	"jg"	},
	{ op_jle,	"jle"	}, { op_jl,	"jl"	}, { op_jmp,	"jmp"	},
	{ op_jnae,	"jnae"	}, { op_jna,	"jna"	}, { op_jnbe,	"jnbe"	},
	{ op_jnb,	"jnb"	}, { op_jnc,	"jnc"	}, { op_jne,	"jne"	},
	{ op_jnge,	"jnge"	}, { op_jng,	"jng"	}, { op_jnle,	"jnle"	},
	{ op_jnl,	"jnl"	}, { op_jno,	"jno"	}, { op_jnp,	"jnp"	},
	{ op_jns,	"jns"	}, { op_jnz,	"jnz"	}, { op_jo,	"jo"	},
	{ op_jpe,	"jpe"	}, { op_jp,	"jp"	}, { op_jpo,	"jpo"	},
	{ op_js,	"js"	}, { op_jz,	"jz"	}, { op_lahf,	"lahf"	},
	{ op_lar,	"lar"	}, { op_lcall,	"lcall"	}, { op_lds,	"lds"	},
	{ op_lea,	"lea"	}, { op_leave,	"leave"	}, { op_les,	"les"	},
	{ op_lgdt,	"lgdt"	}, { op_lidt,	"lidt"	}, { op_ljmp,	"ljmp"	},
	{ op_lldt,	"lldt"	}, { op_lmsw,	"lmsw"	}, { op_lods,	"lods"	},
	{ op_loope,	"loope"	}, { op_loop,	"loop"	}, { op_loopna,	"loopna"},
	{ op_loopne,	"loopne"}, { op_loopnz,	"loopnz"}, { op_looppe,	"looppe"},
	{ op_looppz,	"looppz"}, { op_loopz,	"loopz"	}, { op_lret,	"lret"	},
	{ op_lsl,	"lsl"	}, { op_ltr,	"ltr"	}, { op_mov,	"mov"	},
	{ op_movsb,	"movsb"	}, { op_movs,	"movs"	}, { op_movsw,	"movsw"	},
	{ op_mul,	"mul"	}, { op_neg,	"neg"	}, { op_nop,	"nop"	},
	{ op_not,	"not"	}, { op_or,	"or"	}, { op_out,	"out"	},
	{ op_outs,	"outs"	}, { op_popa,	"popa"	}, { op_popf,	"popf"	},
	{ op_pop,	"pop"	}, { op_pushf,	"pusha"	}, { op_pushf,	"pushf"	},
	{ op_push,	"push"	}, { op_rcl,	"rcl"	}, { op_rcr,	"rcr"	},
	{ op_ret,	"ret"	}, { op_rol,	"rol"	}, { op_ror,	"ror"	},
	{ op_sahf,	"sahf"	}, { op_sal,	"sal"	}, { op_sar,	"sar"	},
	{ op_sbb,	"sbb"	}, { op_scas,	"scas"	}, { op_sgdt,	"sgdt"	},
	{ op_shl,	"shl"	}, { op_shr,	"shr"	}, { op_sidt,	"sidt"	},
	{ op_sldt,	"sldt"	}, { op_smsw,	"smsw"	}, { op_stc,	"stc"	},
	{ op_std,	"std"	}, { op_sti,	"sti"	}, { op_stos,	"stos"	},
	{ op_str,	"str"	}, { op_sub,	"sub"	}, { op_test,	"test"	},
	{ op_verr,	"verr"	}, { op_verw,	"verw"	}, { op_wait,	"wait"	},
	{ op_xchg,	"xchg"	}, { op_xlat,	"xlat"	}, { op_xor,	"xor"	},
	/*
	 *	Prefixes
	 */
