...
static match all_keywords[] = {
	...
	{ op_esc,	"esc"	}, { op_enter,	"enter"	}, { op_hlt,	"hlt"	}, { op_idiv,	"idiv"	}, { op_imul,	"imul"	},
	{ op_in,	"in"	}, { op_inc,	"inc"	}, { op_ins,	"ins"	}, { op_int,	"int"	}, { op_intr,	"intr"	},
	{ op_into,	"into"	}, { op_iret,	"iret"	}, { op_ja,	"ja"	}, { op_jnbe,	"jnbe"	}, { op_jbe,	"jbe"	},
	{ op_jae,	"jae"	}, { op_jna,	"jna"	}, { op_jnb,	"jnb"	}, { op_jb,	"jb"	}, { op_jnae,	"jnae"	},
	...
	{ op_jmp,	"jmp"	}, { op_ljmp,	"ljmp"	}, { op_jnc,	"jnc"	}, { op_jne,	"jne"	}, { op_jnz,	"jnz"	},
	{ op_jno,	"jno"	}, { op_jnp,	"jnp"	}, { op_jpo,	"jpo"	}, { op_jns,	"jns"	},
	{ op_jo,	"jo"	}, { op_jp,	"jp"	}, { op_jpe,	"jpe"	}, { op_js,	"js"	},
	{ op_lahf,	"lahf"	}, { op_lds,	"lds"	}, { op_lea,	"lea"	}, { op_leave,	"leave"	}, { op_les,	"les"	},
	{ op_lods,	"lods"	}, { op_loop,	"loop"	}, { op_loope,	"loope"	}, { op_looppe,	"looppe"}, { op_looppz,	"looppz"},
	...
	{ op_or,	"or"	}, { op_out,	"out"	}, { op_pop,	"pop"	}, { op_popf,	"popf"	},
	{ op_push,	"push"	}, { op_pushf,	"pushf"	}, { op_rcl,	"rcl"	}, { op_rcr,	"rcr"	},
